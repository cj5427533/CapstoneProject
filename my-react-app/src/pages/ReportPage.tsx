...
export function ReportPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert(error instanceof Error ? error.message : '신고 제출에 실패했습니다. 다시 시도해주세요.');
    }
  };
